...
export default defineConfig({
    ...
    projects: [
        ...
        // Role-specific projects (Chromium only) using persisted storageState
        {
            ...
            use: { ...devices['Desktop Chrome'], storageState: 'test-results/.auth/starter.json' },
        },
        {
            name: 'chromium-agency',
            use: { ...devices['Desktop Chrome'], storageState: 'test-results/.auth/agency.json' },
        },
        {
            name: 'chromium-enterprise',
            use: { ...devices['Desktop Chrome'], storageState: 'test-results/.auth/enterprise.json' },
        },
