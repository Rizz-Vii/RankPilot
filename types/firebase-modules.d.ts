...
declare module 'firebase/firestore' {
    ...
    export interface DocumentSnapshot<T = DocumentData> { id: string; data(): T }
    export interface QuerySnapshot<T = DocumentData> { docs: Array<DocumentSnapshot<T>> }
    ...
    export interface DocumentReference<T = DocumentData> { readonly path?: string }
    ...
    export function onSnapshot<T = DocumentData>(q: any, onNext: (snap: QuerySnapshot<T>) => void, onError?: (err: any) => void): Unsubscribe;
...
declare module 'firebase/functions' {
    export function httpsCallable<Req = any, Res = any>(functions: any, name: string): (data: Req) => Promise<{ data: Res }>;
}

declare module 'firebase/auth' {
    export interface User { uid: string;[key: string]: any }
}
