...
declare module 'firebase/app' {
    ...
    export class FirebaseError extends Error { code: string; constructor(code: string, message?: string) }
    const _default: any;
...
declare module 'firebase/firestore' {
    ...
    export function getDocs<T = DocumentData>(q: Query | any): Promise<QuerySnapshot<T>>;
    export function query<T = DocumentData>(col: CollectionReference<T>, ...constraints: QueryConstraint[]): Query<T>;
    ...
    export function onSnapshot<T = DocumentData>(q: Query | any, onNext: (snap: QuerySnapshot<T>) => void, onError?: (err: any) => void): Unsubscribe;
...
declare module 'firebase/analytics' {
    ...
    export function setUserProperties(analytics: Analytics, properties: Record<string, unknown>): void;
    const _default: any;
    export default _default;
}
