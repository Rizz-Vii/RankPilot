...
test.describe('Finance Revenue page - mock gating and provenance', () => {
    ...
    test('Provenance legend shows and KPIs reflect mocks when flag toggled', async ({ page }) => {
        // Warmup
        ...
        await page.goto('/finance/revenue', { waitUntil: 'domcontentloaded', timeout: 60000 });
