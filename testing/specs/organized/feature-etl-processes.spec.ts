...
test.describe("Feature - etl-processes", () => {
  ...
  test("should load etl-processes interface", async ({ page }) => {
    ...
    await expect(
      page.locator('[data-testid="etl-processes-container"]')
    ).toBeVisible();
  });
  ...
  test("should handle etl-processes actions", async ({ page }) => {
    await page.goto("/etl-processes");
    await expect(
      page.locator('[data-testid="etl-processes-actions"]')
    ).toBeVisible();
  });
  ...
  test("should validate etl-processes data", async ({ page }) => {
    await page.goto("/etl-processes");
    await expect(
      page.locator('[data-testid="etl-processes-data"]')
    ).toBeVisible();
  });
  ...
  test("should display etl-processes correctly on mobile", async ({ page }) => {
    ...
    await page.goto("/etl-processes");
    await expect(
      page.locator('[data-testid="etl-processes-mobile"]')
    ).toBeVisible();
  });
  ...
  test("should handle etl-processes errors gracefully", async ({ page }) => {
    ...
    await expect(
      page.locator('[data-testid="etl-processes-error-fallback"]')
    ).toBeVisible();
  });
});
