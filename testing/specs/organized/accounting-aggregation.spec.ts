...
test.describe('accounting aggregation', () => {
    const baseEntries: JournalEntry[] = [
        {
            userId: 'u', date: '2025-08-01', period: '2025-08', createdAt: new Date(), updatedAt: new Date(), lines: [
                { account: 'REV_SUBS', side: 'credit', amount: 50000 },
                { account: 'ASSET_AR', side: 'debit', amount: 50000 }
            ]
        },
        {
            userId: 'u', date: '2025-08-02', period: '2025-08', createdAt: new Date(), updatedAt: new Date(), lines: [
                { account: 'COGS_HOSTING', side: 'debit', amount: 6000 },
                { account: 'LIAB_AP', side: 'credit', amount: 6000 }
            ]
        },
        {
            userId: 'u', date: '2025-08-03', period: '2025-08', createdAt: new Date(), updatedAt: new Date(), lines: [
