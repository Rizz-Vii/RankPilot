...
test.describe('RankPilot NeuroSEO API - Comprehensive Testing', () => {
    ...
    test.describe('NeuroSEO Core Analysis', () => {
        ...
        test('NeuroSEO Analysis - Valid Request', async ({ page }) => {
            ...
            try {
                ...
                neuroseoTestDiagnostics.errors.push(error instanceof Error ? error.message : String(error));
    ...
    test.describe('NeuroSEO Live Analysis', () => {
        ...
        test('NeuroSEO Live Analysis - Start Session', async ({ page }) => {
            ...
            try {
                const response = await page.request.post(`${BASE_URL}/api/neuroseo/live`, {
                    data: {
                        url: TEST_DATA.testUrl,
                        keywords: TEST_DATA.testKeywords,
                        realTime: true
                ...
                if (response.status() === 200) {
                    const data = await response.json();
                    console.log(`   Live Analysis Start: ${JSON.stringify(data, null, 2)}`);
        ...
        test('NeuroSEO Live Analysis - Get Status', async ({ page }) => {
            ...
            try {
                const response = await page.request.get(`${BASE_URL}/api/neuroseo/live/${TEST_DATA.liveAnalysisId}`);
        ...
        test('NeuroSEO Live Analysis - Stop Session', async ({ page }) => {
            ...
            try {
                const response = await page.request.delete(`${BASE_URL}/api/neuroseo/live/${TEST_DATA.liveAnalysisId}`);
                ...
                if (response.status() === 200) {
                    const data = await response.json();
                    console.log(`   Live Analysis Stop: ${JSON.stringify(data, null, 2)}`);
    ...
    test.describe('NeuroSEO Metrics & Reporting', () => {
        ...
        test('NeuroSEO Metrics - Get Analysis Metrics', async ({ page }) => {
            ...
            try {
                const response = await page.request.get(`${BASE_URL}/api/neuroseo/metrics`);
        ...
        test('NeuroSEO Metrics Export - CSV Format', async ({ page }) => {
            ...
            try {
                const response = await page.request.get(`${BASE_URL}/api/neuroseo/metrics-export?format=csv`);
    ...
    test.describe('NeuroSEO Streaming & Real-time', () => {
        ...
        test('NeuroSEO Streaming - WebSocket Connection', async ({ page }) => {
            ...
            try {
                const response = await page.request.get(`${BASE_URL}/api/neuroseo/stream`);
        ...
        test('NeuroSEO Real-time Updates - Subscribe', async ({ page }) => {
            ...
            try {
                const response = await page.request.post(`${BASE_URL}/api/streaming/real-time`, {
                    data: {
                ...
                if (response.status() === 200) {
                    const data = await response.json();
                    console.log(`   Subscription Result: ${JSON.stringify(data, null, 2)}`);
    ...
    test.describe('NeuroSEO Rate Limiting & Performance', () => {
        ...
        test('NeuroSEO Rate Limiting - Multiple Analysis Requests', async ({ page }) => {
            ...
            console.log(`   Rate Limited Requests: ${rateLimitedCount}/${totalRequests}`);
            ...
            const hasRateLimiting = rateLimitedCount > 0 || responses.some(r => [400, 401, 403, 402].includes(r.status()));
