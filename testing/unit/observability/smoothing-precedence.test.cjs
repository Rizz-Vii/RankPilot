...
function chooseBaseline({ smoothed, serverMA7, computedMA7 }) {
  if (typeof smoothed === "number")
    return { source: "smoothed", value: smoothed };
  if (typeof serverMA7 === "number")
    return { source: "serverMA7", value: serverMA7 };
  if (computedMA7 && computedMA7.length)
    return { source: "computedMA7", value: computedMA7[0] };
