...
describe('FeatureGate Component', () => {
    ...
    describe('FeatureGate Component Logic', () => {
        it('should determine access correctly for different user tiers', () => {
            ...
            const hasAccess = userAccess ? userAccess.capabilities.includes(feature) : false;
        ...
        it('should handle entitlement-based features', () => {
            ...
            const hasEntitlement = userAccess ? userAccess.entitlements.includes(feature) : false;
    ...
    describe('Feature Access Logic', () => {
        it('should correctly determine tier hierarchy', () => {
            ...
            const starterToAgency = tiers.indexOf('starter') < tiers.indexOf('agency');
            const agencyToEnterprise = tiers.indexOf('agency') < tiers.indexOf('enterprise');
        ...
        it('should handle multiple capability requirements', () => {
            const userCapabilities = ['dashboard', 'keyword_analysis', 'competitor_analysis'];
