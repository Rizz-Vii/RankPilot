...
const { sidebarStyles } = require('../../../src/lib/design-system/sidebar-styles');
...
describe('Design System semantic color compliance', () => {
  it('exports contain no raw palette utility classes', () => {
    ...
    if(hits.length){
      console.error('Found raw palette classes in design-system exports:', hits);
    }
    expect(hits, 'No raw palette classes should remain in design-system exports').to.have.length(0);
  });
});
