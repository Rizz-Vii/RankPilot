...
import type { SalesMetricsSnapshotDoc, SalesForecastSnapshotDoc } from '@/lib/services/sales-automation-snapshots';
...
describe('Sales Snapshot Types', () => {
    it('SalesMetricsSnapshotDoc shape', () => {
        const sample: SalesMetricsSnapshotDoc = {
            id: 'abc', userId: 'u1', pipeline: 1000, closedWon: 200, totalDeals: 5
        };
    ...
    it('SalesForecastSnapshotDoc shape', () => {
        const sample: SalesForecastSnapshotDoc = {
            id: 'f1', userId: 'u1', period: '2025-08-01', forecast: 12345
        };
