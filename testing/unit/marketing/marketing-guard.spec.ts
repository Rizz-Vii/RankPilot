...
describe("MKT-01 sanitizeMarketingCampaignDoc", () => {
  ...
  it("normalizes numeric-like strings and leaves numbers unchanged", () => {
    interface RawCampaign extends Record<string, unknown> {
      impressions?: unknown;
      clicks?: unknown;
      spend?: unknown;
      roi?: unknown;
    ...
    const rawCampaign: RawCampaign = {
      impressions: "1000",
      clicks: "250",
      spend: "89.5",
      roi: 4,
      period: "2025-08-11T12:00:00Z",
    };
  ...
  it("falls back to 0 for unparsable numeric fields", () => {
    interface RawCampaign2 extends Record<string, unknown> {
      impressions?: unknown;
      clicks?: unknown;
      spend?: unknown;
      ctr?: unknown;
    }
    const rawBad: RawCampaign2 = {
      impressions: "abc",
      clicks: "xyz",
      spend: "NaN",
      ctr: 0.5,
