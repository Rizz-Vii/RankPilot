...
describe('fetchSSE adapter (skipped by default)', () => {
    const realFetch: typeof globalThis.fetch | undefined = (global as unknown as { fetch?: typeof globalThis.fetch }).fetch;

    beforeEach(() => {
        (global as any).fetch = (_url: string, init?: any) => new Promise((_resolve, reject) => {
    ...
    it('merges external signal', async () => {
        ...
        const p = fetchSSE('http://example.com/never', { signal: ctl.signal, timeoutMs: 10_000 });
