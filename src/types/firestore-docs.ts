...
export function toDate(
  v: Date | FireTsLike | undefined | null
): Date | undefined {
...
// ----- Mappers -----
export function mapMarketingCampaignDoc(
  id: string,
  raw: MarketingCampaignFirestore
...
export function mapForecastSnapshot(
  raw: ForecastSnapshotFirestore
): ForecastSnapshotRuntime {
  return {
    period: raw.period,
...
export function mapFinanceInvoiceDoc(
  id: string,
  raw: FinanceInvoiceFirestore
