...
export default async function Head() {
  ...
  return (
    <>
      ...
      <meta
        name="description"
        content="Unified AI platform for technical SEO audits, content intelligence, competitor tracking, and growth automation."
      />
      ...
      <meta
        property="og:title"
        content="RankPilot – NeuroSEO™ Growth Platform"
      />
      <meta
      ...
      <meta
        property="og:image"
        content="https://rankpilot-h3jpc.web.app/og-image.png"
      />
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(orgAndProductJsonLd),
        }}
        nonce={cspNonce}
      />
    </>
