        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
              Replace fragmented audit, keyword, content, link, and reporting
              stacks with a unified intelligence layer. Six coordinated AI
              engines prioritize, validate, and accelerate compound organic
              growth.
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Six specialized, interoperable engines orchestrated for precision
