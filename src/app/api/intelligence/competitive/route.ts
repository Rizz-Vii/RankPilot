...
function narrowTrackingConfig(input: unknown): TrackingConfig | undefined {
  ...
  const pages = Array.isArray(obj.pages)
    ? (obj.pages.filter((p) => typeof p === "string") as string[])
    : [];
  ...
  const alertThresholds: Record<string, number> =
    typeof obj.alertThresholds === "object" && obj.alertThresholds !== null
      ? Object.entries(obj.alertThresholds as Record<string, unknown>).reduce<
...
export const POST = withProvenance(
  async function POST(request: NextRequest) {
    ...
    try {
      ...
      if (!authHeader?.startsWith("Bearer ")) {
        return NextResponse.json(
          enforceProvenance(
            ...
            { path: "intelligence/competitive", note: "auth" }
          ),
          { status: 401 }
        );
      }
      ...
      try {
        decodedToken = (await adminAuth.verifyIdToken(token)) as {
          uid: string;
          tier?: string;
        };
      } catch (error) {
        console.error(
          "[CompetitiveIntelligenceAPI] Token verification error:",
          error
        );
        return NextResponse.json(
          enforceProvenance(
      ...
      if (!["agency", "enterprise", "admin"].includes(userTier)) {
        return NextResponse.json(
          enforceProvenance(
            ...
            { path: "intelligence/competitive", note: "tier" }
          ),
          { status: 403 }
        );
      }
      ...
      switch (body.action) {
        case "add":
          if (!body.domain) {
            return NextResponse.json(
              enforceProvenance(
                ...
                { path: "intelligence/competitive", note: "validation" }
              ),
              { status: 400 }
            );
          }
          ...
          const competitor =
            await firecrawlCompetitiveIntelligence.addCompetitor(
              userId,
              body.domain,
              {
                name: body.name,
          ...
          return NextResponse.json(
            enforceProvenance(
              ...
              { path: "intelligence/competitive", note: "add" }
            )
          );
        ...
        case "analyze":
          ...
          await firecrawlCompetitiveIntelligence.analyzeCompetitor(
            body.competitorId
          );
          ...
          return NextResponse.json(
            enforceProvenance(
              ...
              { path: "intelligence/competitive", note: "analyze" }
            )
          );
        ...
        case "list": {
          ...
          return NextResponse.json(
            enforceProvenance(
              ...
              { path: "intelligence/competitive", note: "list" }
            )
          );
        }
        ...
        case "update":
          ...
          if (!updated) {
            return NextResponse.json(
              enforceProvenance(
                ...
                { path: "intelligence/competitive", note: "not_found" }
              ),
              { status: 404 }
            );
          }
          ...
          return NextResponse.json(
            enforceProvenance(
              ...
              { path: "intelligence/competitive", note: "update" }
            )
          );
        ...
        case "delete":
          ...
          return NextResponse.json(
            enforceProvenance(
              ...
              { path: "intelligence/competitive", note: "delete" }
            )
          );
        ...
        case "report":
          if (
            ...
            body.reportConfig.competitorIds.length === 0
          ) {
            return NextResponse.json(
              enforceProvenance(
                {
          ...
          const report =
            await firecrawlCompetitiveIntelligence.generateCompetitiveReport(
              userId,
              body.reportConfig.competitorIds,
          ...
          return NextResponse.json(
            enforceProvenance(
                ...
                report: {
                  ...
                  findings: {
                    ...
                    recommendationsCount:
                      report.findings.recommendations.length,
                  },
              ...
              { path: "intelligence/competitive", note: "report" }
            )
          );
        ...
        case "get":
          ...
          return NextResponse.json(
            enforceProvenance(
              ...
              { path: "intelligence/competitive", note: "get" }
            )
          );
        ...
        default:
          return NextResponse.json(
            enforceProvenance(
              ...
              { path: "intelligence/competitive", note: "invalid_action" }
            ),
            { status: 400 }
          );
      }
      ...
      return NextResponse.json(
        enforceProvenance(
          ...
          { path: "intelligence/competitive", note: "exception" }
        ),
        { status: 500 }
      );
    }
  ...
  async function GET(request: NextRequest) {
    ...
    try {
      ...
      const overview = {
        ...
        activeAnalyses: userCompetitors.filter(
          (c) =>
            c.lastAnalysis?.timestamp &&
            Date.now() - c.lastAnalysis.timestamp < 7 * 24 * 60 * 60 * 1000
        ).length,
        totalAnalyses: userCompetitors.reduce(
          (sum, c) => sum + c.metadata.analysisCount,
          0
        ),
      ...
      return NextResponse.json(
        enforceProvenance(
          ...
          { path: "intelligence/competitive", note: "overview" }
        )
      );
    } catch (error) {
      console.error("[CompetitiveIntelligenceAPI] Error:", error);
