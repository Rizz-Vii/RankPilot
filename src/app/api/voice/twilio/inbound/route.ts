...
export async function POST(req: NextRequest) {
    try {
        ...
        const payload = form ? Object.fromEntries(form.entries()) : await req.json().catch(() => ({}));
        ...
        try {
            ...
            type AdminCollection = { doc: (id: string) => { set: (data: unknown, opts?: { merge?: boolean }) => Promise<void> } };
