...
export default function SiteIngestionAdminPage() {
  ...
  return (
    <div className="p-6 space-y-4 max-w-2xl">
      ...
      <div className="space-y-2">
        ...
        <div className="flex items-center gap-2">
          ...
          <input
            ...
            value={maxPages}
            onChange={(e: ChangeEvent<HTMLInputElement>) =>
              setMaxPages(Math.max(1, parseInt(e.target.value, 10) || 1))
            }
          />
        </div>
        <button
          ...
          disabled={!baseUrl || status === "Running"}
      ...
      {result && (
        <pre className="text-xs bg-secondary text-secondary-foreground p-3 rounded overflow-auto">
