...
export const metadata = { title: 'Email Campaigns | Marketing Automation' };
    ...
    <FeatureGate feature="marketing_email_campaigns" requiredTier="enterprise" showUpgrade>
      <div className="space-y-8 p-6">
        ...
        <section className="space-y-4">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            <div className="rounded-xl border p-4 bg-background/50 space-y-2"><p className="text-sm font-medium">Create Campaign</p><p className="text-xs text-muted-foreground">Start new multi-touch sequence.</p><button className="text-xs font-medium px-2 py-1 rounded-md bg-primary/10 text-primary hover:bg-primary/20 transition">Start</button></div>
            <div className="rounded-xl border p-4 bg-background/50 space-y-2"><p className="text-sm font-medium">Optimize Send Time</p><p className="text-xs text-muted-foreground">Run AI timing model.</p><button className="text-xs font-medium px-2 py-1 rounded-md bg-primary/10 text-primary hover:bg-primary/20 transition">Optimize</button></div>
            <div className="rounded-xl border p-4 bg-background/50 space-y-2"><p className="text-sm font-medium">Generate Content</p><p className="text-xs text-muted-foreground">Produce variant subject lines.</p><button className="text-xs font-medium px-2 py-1 rounded-md bg-primary/10 text-primary hover:bg-primary/20 transition">Generate</button></div>
          </div>
        </section>
      </div>
    </FeatureGate>
