        ...
        rewriteRecommendations: [
          {
            ...
            comparisonMatrix: {
              ...
              winner: "enhanced",
              reasoning:
                "Enhanced version shows improved readability and SEO metrics",
            },
          },
        ],
        overallScore: 82,
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8">
      ...
      <div className="text-center">
        <h1 className="text-4xl font-bold mb-2">NeuroSEO™ Content Analyzer</h1>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Analyze your content for SEO optimization, readability, and
                        ...
                        <div key={index} className="space-y-4">
                          <div>
                            ...
                            <div className="p-3 rounded border text-sm bg-success/10 border-success/30 text-success-foreground/90">
                              ...
                              {rewrite.originalAnalysis.wordCount} words
                            </div>
                          </div>
                          ...
                          <div>
                            ...
                            <ul className="grid md:grid-cols-2 gap-2">
                              <li className="flex items-center gap-2 text-sm">
                                ...
                                Readability Score:{" "}
                                {rewrite.originalAnalysis.readabilityScore}
                              </li>
                              <li className="flex items-center gap-2 text-sm">
                                <CheckCircle className="h-4 w-4 text-success-foreground" />
                          ...
                          <div className="grid md:grid-cols-3 gap-4 mt-4">
                            ...
                            <div className="text-center p-3 rounded bg-success/10">
                              <div className="font-bold text-success-foreground">
                                {rewrite.originalAnalysis.seoScore}
                              </div>
                            ...
                            <div className="text-center p-3 rounded bg-accent/10">
                              <div className="font-bold text-accent">
                                {rewrite.originalAnalysis.structureScore}
                              </div>
