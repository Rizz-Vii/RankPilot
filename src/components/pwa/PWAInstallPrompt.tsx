          ...
          <Card className="w-full max-w-md mx-auto animate-in fade-in-0 zoom-in-95 duration-200">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="text-xs text-muted-foreground text-center">
                {isIOS ? (
                  <p>
                    On iPhone (Safari or Chrome), tap the Share button, then
                    "Add to Home Screen" to install the app.
                  </p>
                ) : (
                  <p>
                    The app will be added to your home screen and can be used
                    offline
                  </p>
                )}
              </div>
    ...
    <div className={cn("relative", className)}>
      ...
      >
        <div className="flex items-center gap-1">
          ...
          {isInstalled && (
            <Smartphone className="h-4 w-4 text-info-foreground" />
          )}
          {notificationsEnabled && (
            <Bell className="h-4 w-4 text-info-foreground" />
          )}
