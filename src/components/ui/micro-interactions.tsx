  ...
  return (
    <div className={className}>
      ...
      <AnimatePresence mode="wait">
        {isOpen && (
          <Animated variant={getAnimationVariant()} className="overflow-hidden">
...
export function LoadingAnimation({
  ...
  if (shouldReduceMotion()) {
    return (
      <div
        className={`${sizeClasses[size]} bg-primary rounded opacity-50 ${className}`}
      />
    );
  }
        ...
        >
          ...
          <AnimatePresence>
            {openSections.has(section.id) && (
              <Animated variant="slideDown" className="overflow-hidden">
