...
const iconAnimations: Record<FeatureTitle, Variants> = {
    "Keyword Intelligence": {
        ...
        animate: { y: 0, opacity: 1, scale: 1, rotate: 0, transition: { type: "spring", stiffness: 300, damping: 18 } },
        hover: { scale: 1.2, rotate: 15, x: 30, transition: { type: "spring", stiffness: 200, damping: 15 } },
    },
    "Competitor Tracking": {
        initial: { x: 24, opacity: 0, scale: 0.7, rotate: 20 },
        animate: { x: 0, opacity: 1, scale: 1, rotate: 0, transition: { type: "spring", stiffness: 320, damping: 18 } },
        hover: { scale: 1.2, rotate: 2, x: 40, transition: { type: "spring", stiffness: 200, damping: 15 } },
    },
    "NeuroSemantic Engine": {
...
const features: FeatureItem[] = [
    ...
    { title: "Backlink Intelligence", desc: "Acquisition slope • authority velocity • toxicity dampening patterns.", icon: Link2, detailedDescription: "Consolidated backlink profiling with momentum detection, emerging referrers, decay risk forecasting and trust-layer heuristics—informing safer acquisition prioritization." },
    { title: "Automation Recipes", desc: "Trigger → transform → action flows across audits, content & outreach.", icon: Workflow, detailedDescription: "Composable, reusable automation graph: schedule or event-trigger technical rescans, content refresh scoring, outreach queue hydration and structured export pushes without brittle scripting." },
    { title: "Content RewriteGen", desc: "On‑demand refactors • tone adaptation • semantic enrichment layers.", icon: Zap, detailedDescription: "Guided, constraint-aware regeneration preserving factual anchors while boosting semantic density, intent alignment and internal link anchor optimization—human-in-the-loop safe guards included." },
    { title: "Revenue & Attribution", desc: "Pipeline influence • assisted conversions • growth cohort lift.", icon: Coins, detailedDescription: "Connect visibility movements to commercial impact via blended attribution heuristics, cohort progression slope tracking and assisted contribution modeling—finally prove organic's compounding delta." },
    { title: "Team Collaboration", desc: "Shared workspaces • context-preserving comments • role / tier gating.", icon: Users2, detailedDescription: "Align stakeholders with prioritized queues, inline threaded discussions, change tracking snapshots and progressive disclosure of advanced modules by role & subscription tier." },
    { title: "Performance & Core Web Vitals", desc: "Real-time lab + field blend • regression detection • impact modeling.", icon: LineChart, detailedDescription: "Unified performance telemetry overlays indexation & ranking volatility to highlight causal chains; regression early-warning layers feed into automation recipes for proactive remediation." },
];
