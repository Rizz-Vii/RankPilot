...
export default function SiteHeader() {
  ...
  const { theme, setTheme, isDark, isHighContrast, setPreferences } =
    useTheme();
  ...
  const toggleTheme = (): void => {
    ...
    const current: ThemeMode = isHighContrast()
      ? "high-contrast"
      : (theme as ThemeMode);
        ...
        >
          <div className="container flex h-16 max-w-7xl items-center justify-between px-4 mx-auto">
            ...
            <div className="hidden md:flex items-center space-x-4 flex-nowrap">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                        ...
                        {hydrated ? (
                          isHighContrast() ? (
                            <span className="relative inline-flex">
                              ...
                              <span className="absolute -top-1 -right-1 text-[8px] px-1 py-[1px] leading-none rounded bg-warning text-warning-foreground font-bold">
                                HC
                              </span>
                            </span>
                          ) : isDark() ? (
                ...
                <div className="lg:hidden">
                  <Tooltip>
                    ...
                    <TooltipContent>Command (Ctrl/Cmd+K)</TooltipContent>
                  </Tooltip>
                </div>
              ...
              {!hydrated ? null : user ? ( // Collapsed: render nothing pre-hydration (no spacer)
                <DropdownMenu>
