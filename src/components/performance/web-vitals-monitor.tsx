  ...
  return (
    <div className="fixed bottom-4 right-4 bg-black/90 text-white p-4 rounded-lg font-mono text-xs z-50 min-w-[200px]">
      ...
      <div className="space-y-1">
        {vitals.lcp && (
          <div
            className={`flex justify-between ${getMetricColor(vitals.lcp.rating)}`}
          >
            <span>LCP:</span>
        ...
        {vitals.inp && (
          <div
            className={`flex justify-between ${getMetricColor(vitals.inp.rating)}`}
          >
            <span>INP:</span>
        ...
        {vitals.fcp && (
          <div
            className={`flex justify-between ${getMetricColor(vitals.fcp.rating)}`}
          >
            <span>FCP:</span>
        ...
        {vitals.cls && (
          <div
            className={`flex justify-between ${getMetricColor(vitals.cls.rating)}`}
          >
            <span>CLS:</span>
        ...
        {vitals.ttfb && (
          <div
            className={`flex justify-between ${getMetricColor(vitals.ttfb.rating)}`}
          >
            <span>TTFB:</span>
...
export function PerformanceIndicator() {
  ...
  return (
    ...
    ${
      vitals.overallScore >= 90
        ? "bg-success"
        : vitals.overallScore >= 75
          ? "bg-warning"
          : "bg-destructive"
    }
      `}
