...
export class AccessibilityManager {
  ...
  private listeners: Set<(announcement: AccessibilityAnnouncement) => void> =
    new Set();
  ...
  private announceHelp() {
    ...
    this.announce(
      `Available keyboard shortcuts: ${shortcuts}. Available voice commands: ${voiceCommands}`,
      "polite",
      "log"
    );
  }
  ...
  // Listeners
  subscribe(
    listener: (announcement: AccessibilityAnnouncement) => void
  ): () => void {
...
export function useAccessibility() {
  ...
  return {
    ...
    announceNavigation:
      accessibilityManager.announceNavigation.bind(accessibilityManager),
    announceAction:
      accessibilityManager.announceAction.bind(accessibilityManager),
    announceError:
      accessibilityManager.announceError.bind(accessibilityManager),
    announceSuccess:
      accessibilityManager.announceSuccess.bind(accessibilityManager),
    focusElement: accessibilityManager.focusElement.bind(accessibilityManager),
    focusPrevious:
      accessibilityManager.focusPrevious.bind(accessibilityManager),
    trapFocus: accessibilityManager.trapFocus.bind(accessibilityManager),
    registerShortcut:
      accessibilityManager.registerShortcut.bind(accessibilityManager),
    registerVoiceCommand:
      accessibilityManager.registerVoiceCommand.bind(accessibilityManager),
    startListening:
      accessibilityManager.startListening.bind(accessibilityManager),
    stopListening:
      accessibilityManager.stopListening.bind(accessibilityManager),
