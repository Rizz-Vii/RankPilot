...
export interface NeuroSeoJobContext { userId: string; urls: string[]; keywords: string[] }
export interface CrawlerTask { url: string; depth: number }
export interface RewriteTransition { from: string; to: string; score: number }
export interface EngineResult { engine: string; data: UnknownObject }
