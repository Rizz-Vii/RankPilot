...
export function persistMetricsSnapshot(): { ok: boolean; path?: string; error?: string } {
    try {
...
export function recordAnalysisRun() { counters.analysisRuns += 1; }
export function recordCacheHit() { counters.analysisCacheHits += 1; }
export function recordGuardStrip() { counters.guardStrips += 1; }
export function recordWorkflowRun() { counters.workflowRuns += 1; }
export function recordWorkflowFailure() { counters.workflowFailures += 1; }
export function recordStripeWebhookError() { counters.stripeWebhookErrors += 1; }
export function getNeuroseoMetricsSnapshot(): NeuroseoMetricsSnapshot { return { ...counters }; }
