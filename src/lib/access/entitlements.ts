...
export const DEFAULT_ENTITLEMENTS: EntitlementMap = {
  ...
  dedicated_support: {
    ...
    description: "Dedicated account manager / CSM",
  },
  enterprise_sla: {
    minimumTier: "enterprise",
    description: "Contractual enterprise SLA coverage",
  },
};
...
} = { map: DEFAULT_ENTITLEMENTS, loadedAt: 0, source: "default" };
...
export function getEntitlementsSource(): "dynamic" | "default" {
  return cache.source;
}
