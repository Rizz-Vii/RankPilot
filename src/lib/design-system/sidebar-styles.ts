...
export const sidebarStyles = {
  ...
  navGroup: {
    container: "mb-6",
    header:
      "text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-2 px-3",
    content: "space-y-1",
  },
  ...
  userSwitch: {
    ...
    trigger:
      "flex items-center gap-3 w-full px-3 py-3 rounded-lg hover:bg-sidebar-accent",
    dropdown:
      "bg-sidebar border border-sidebar-border rounded-lg shadow-lg mt-1",
    userItem:
