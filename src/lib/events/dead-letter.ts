...
export function pushDeadLetter(type: string, payload: { [k: string]: unknown } | undefined, error: unknown, attempts: number) {
...
export function __resetDeadLettersTestOnly() { dlq.length = 0; }
