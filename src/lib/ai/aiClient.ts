...
export async function openAIEmbeddingOrNull(text: string): Promise<number[] | null> {
...
export async function fallbackOneShot(systemPrompt: string, userMessage: string, maxTokens = 800): Promise<string> {
    const geminiKey = getGeminiKey();
