import { requireAdminFromHeaders, type AdminCheckResult } from '@/lib/auth/requireAdmin';
...
export function withAdmin(
    ...
    options?: { path?: string; unauthorizedMessage?: string; forbiddenMessage?: string; extraHeaders?: HeadersInit | ((req: NextRequest) => HeadersInit) }
) {
    ...
    return async function wrapped(req: NextRequest): Promise<Response> {
        try {
            ...
            const hdrs = typeof options?.extraHeaders === 'function'
