 ...
 */
export async function requireAdminFromHeaders(headers: Headers): Promise<AdminCheckResult> {
    ...
    try {
        ...
        const claimAdmin = Boolean((decoded as Record<string, unknown>)['admin'] === true);
        ...
        if (e && typeof e === 'object' && 'status' in (e as Record<string, unknown>)) {
