      ...
      return (
        <div className="text-xs text-muted-foreground border rounded-md px-2 py-1 bg-muted/30 max-w-[260px]">
          ...
          <ul className="space-y-0.5 list-disc pl-4 marker:text-muted-foreground/70">
            <li>
              <span className="font-medium">Live Data:</span> Fresh AI analysis
              just computed.
            </li>
            <li>
              <span className="font-medium">Cache:</span> Recently cached result
              (≤10m old).
            </li>
            <li>
              <span className="font-medium">Demo Data:</span> Deterministic
              fallback sample.
            </li>
          </ul>
        </div>
