...
In terms of AI safety and governance, the system includes special provisions. All AI-generated content or actions pass through a provenance and audit middleware which tags responses with a __provenance field or header
GitHub
...
GitHub
. This ensures compliance with the internal AI governance policy PROV-01 – every piece of AI-generated content or decision can be traced. The change included new utility functions withProvenance/enforceProvenance and updated tests to require a __provenance field in JSON and an x-provenance header in CSV responses
GitHub
