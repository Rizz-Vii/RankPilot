...
const t1: Task = { id: '1', title: 'Update Firestore events', raw: '', domain: '', status: 'TODO' };
const t2: Task = { id: '2', title: 'Add Observability doc', raw: 'docs', domain: '', status: 'TODO' };
const t3: Task = { id: '3', title: 'Nav React component', raw: 'page.tsx', domain: '', status: 'TODO' };
