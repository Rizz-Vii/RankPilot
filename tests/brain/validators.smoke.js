...
(async () => {
  ...
  const v = await runValidators({ cfg: { tools: { typecheck: false, eslint: false, unitTests: false, playwright: false, a11y: false, lighthouse: false, deadcode: false, secrets: false, depAudit: false } } });
