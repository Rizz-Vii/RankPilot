export const rule = {
  meta: {
    ...
    docs: {
      description:
        "Disallow raw hex colors outside allowlist; enforce design tokens.",
    },
    schema: [
      {
        type: "object",
        ...
        while ((m = HEX.exec(text))) {
          ...
          if (!allowList.has(value)) {
            context.report({
              ...
              message: `Raw hex color ${value} detected. Use design tokens or add to allowlist if justified.`,
            });
          }
        }
      },
