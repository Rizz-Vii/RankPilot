...
(function run() {
    ...
    const subs: SubscriptionEvent[] = [
        { userId: 'u_active1', amountMonthly: 100, status: 'active', startedAt: startPrevMonth },
        { userId: 'u_active2', amountMonthly: 50, status: 'active', startedAt: startPrevMonth },
        { userId: 'u_churned', amountMonthly: 80, status: 'canceled', startedAt: startPrevMonth, canceledAt: canceledMidMonth },
    ...
    assert.strictEqual(snap.activeCustomers, 2, 'Active customers excludes canceled');
    ...
    const subsZero: SubscriptionEvent[] = [
        { userId: 'u1', amountMonthly: 30, status: 'active', startedAt: startPrevMonth },
        { userId: 'u2', amountMonthly: 70, status: 'active', startedAt: startPrevMonth }
    ];
