...
const PROJECTS = [
  ...
  { id: 'project2', name: 'Content Plan', description: 'Content Planning Project' }
];
const INTEGRATIONS = [
...
const USERS = [
  { userId: 'Y0hv244mtsYk4dwsxBCS1xBOhab2', name: 'Starter User', email: 'starter@rankpilot.com', role: 'starter' },
  { userId: 'agencyUserId', name: 'Agency User', email: 'agency@rankpilot.com', role: 'agency' },
  { userId: 'm7nbs1tNrxYIlaclebE5sKI6ok53', name: 'Enterprise User', email: 'enterprise@rankpilot.com', role: 'enterprise' },
  { userId: 'UFGrzIf2N3UTPd5Xz7vT8tMZpHJ3', name: 'Admin User', email: 'admin@rankpilot.com', role: 'admin' }
];
...
async function seed() {
  ...
  for (const user of USERS) {
    ...
    if (user.email === "enterprise@rankpilot.com") subscriptionTier = "enterprise";
