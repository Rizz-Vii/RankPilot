...
async function run() {
  ...
  try {
    ...
    const err =
      e && typeof e === "object"
        ? (e as { message?: string; status?: unknown; code?: unknown })
        : {};
    summary.embedding.success = false;
    summary.embedding.error =
  ...
  try {
    ...
    summary.chat.model =
      typeof (chat as unknown as { model?: unknown }).model === "string"
        ? (chat as unknown as { model?: string }).model
        : "gpt-4o-mini";
  } catch (e: unknown) {
    const err =
      e && typeof e === "object"
